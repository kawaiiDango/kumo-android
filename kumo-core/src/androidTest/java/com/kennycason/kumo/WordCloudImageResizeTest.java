...
public class WordCloudImageResizeTest {
    ...
    public void whaleImgLargeToSmallTest() throws IOException {
        ...
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output_test/a_whale_large_to_small.png"));
        inputStream.close();
    }
    @Test
    public void whaleImgSmallToLargeTest() throws IOException {
        ...
        wordCloud.setFontScalar(new SqrtFontScalar(10, 50));
        wordCloud.build(wordFrequencies);
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output_test/a_whale_small_to_large.png"));
