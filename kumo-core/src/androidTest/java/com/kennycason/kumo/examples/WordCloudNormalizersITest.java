...
public class WordCloudNormalizersITest {
    ...
    public void upperCaseNormalizer() throws IOException {
        ...
        final List<WordFrequency> wordFrequencies = KumoTestUtils.loadFreqFromUrl(frequencyAnalyzer, new URL("https://web.archive.org/web/20210115135445/https://kennycason.com/"));
        ...
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output/kennycason_com_wordcloud_circle_uppercase.png"));
    }
    ...
    public void upsideDownNormalizer() throws IOException {
        ...
        wordCloud.build(wordFrequencies);
        LOGGER.info("Took {}ms to build", System.currentTimeMillis() - startTime);
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output/kennycason_com_wordcloud_circle_upsidedown.png"));
    }
    ...
    public void hexStringNormalizer() throws IOException {
        ...
        wordCloud.build(wordFrequencies);
        LOGGER.info("Took {}ms to build", System.currentTimeMillis() - startTime);
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output/kennycason_com_wordcloud_circle_hex.png"));
    }
    ...
    public void noNormalizationOrFilters() throws IOException {
        ...
        wordCloud.build(wordFrequencies);
        LOGGER.info("Took {}ms to build", System.currentTimeMillis() - startTime);
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output/kennycason_com_wordcloud_circle_normalization_or_filter.png"));
    }
    ...
    public void bubbleText() throws IOException {
        ...
        wordCloud.build(wordFrequencies);
        LOGGER.info("Took {}ms to build", System.currentTimeMillis() - startTime);
        wordCloud.writeToFile(KumoTestUtils.prependDataDir("output/bubbletext.png"));
    }
