...
public class FrequencyFileLoaderTest {
    ...
    public void basic() throws IOException {
        InputStream stream = new ByteArrayInputStream(("100:cat\n" +
                "50:dog\n" +
                "25:fish\n" +
                "75:frog").getBytes(StandardCharsets.UTF_8));
        final List<WordFrequency> wordFrequencies = FREQUENCY_FILE_LOADER.load(stream);
